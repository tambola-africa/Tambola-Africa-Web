          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:items-start">
            <div className="space-y-4">
              <div className="inline-flex rounded-full border border-[var(--gold)]/40 bg-[var(--surface)] px-3 py-1 text-xs font-semibold text-black/80 dark:border-[var(--gold)]/30 dark:bg-white/5 dark:text-white/80">
                Participation sécurisée & transparente
              </div>
              ...
              <form className="space-y-6" onSubmit={onSubmit}>
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full rounded-2xl border border-black/10 bg-white px-4 py-3 text-sm outline-none focus:border-[var(--gold)]/60 focus:ring-2 focus:ring-[var(--gold)]/15 dark:border-white/10 dark:bg-black"
                ...
                <label className="flex items-start gap-3 text-sm text-black/70 dark:text-white/70">
                  <input
                    ...
                    className="mt-1 h-4 w-4 rounded border-black/20 accent-[var(--accent)]"
                  />
                  <span>
